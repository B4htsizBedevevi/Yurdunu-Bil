...
function loadLibraryReader(){if(window.YB106_LIBRARY_CARDS__||window.__YB106_LOADING__)return;window.__YB106_LOADING__=true;const s=document.createElement('script');s.src='v106-library-cards.js?v=106.0.0';s.onload=()=>{window.__YB106_LOADING__=false};s.onerror=()=>{window.__YB106_LOADING__=false};document.body.appendChild(s)}
