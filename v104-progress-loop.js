...
function loadLibraryReader(){if(window.YB105LibraryReader||window.__YB105_LOADING__)return;window.__YB105_LOADING__=true;const s=document.createElement('script');s.src='v105-library-reader.js?v=105.0.0';s.onload=()=>{window.__YB105_LOADING__=false};s.onerror=()=>{window.__YB105_LOADING__=false};document.body.appendChild(s)}
