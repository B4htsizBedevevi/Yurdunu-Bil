...
async function boot(){await Promise.all([load('link',{rel:'stylesheet',href:'/v55-games-plus.css?v=56.0.0'}),load('link',{rel:'stylesheet',href:'/v56-retention.css?v=56.0.0'}),load('link',{rel:'manifest',href:'/manifest.webmanifest'}),load('link',{rel:'stylesheet',href:'/v56-profile-settings.css?v=56.0.0'})]);await load('script',{src:'/v55-games-plus.js?v=56.0.0'});await load('script',{src:'/v56-retention.js?v=56.0.0'});await load('script',{src:'/v56-stability.js?v=56.0.0'});await load('script',{src:'/v56-profile-settings.js?v=56.0.0'});await load('link',{rel:'stylesheet',href:'/v56-stability.css?v=56.0.0'});}
