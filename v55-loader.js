...
function boot(){Promise.all([load('link',{rel:'stylesheet',href:'/v55-games-plus.css?v=55.0.0'}),load('link',{rel:'stylesheet',href:'/v56-retention.css?v=56.0.0'}),load('link',{rel:'manifest',href:'/manifest.webmanifest'})]).then(()=>load('script',{src:'/v55-games-plus.js?v=55.0.0'})).then(()=>load('script',{src:'/v56-retention.js?v=56.0.0'}));}
