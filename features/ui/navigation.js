...
document.addEventListener('click',e=>{const b=e.target?.closest?.('[data-view="arena"],[data-mobile-view="arena"]');if(!b)return;e.preventDefault();e.stopImmediatePropagation();navigate('arena')},true);
