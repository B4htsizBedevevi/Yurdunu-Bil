...
const syncRoute=v=>{const route=ROUTES.has(v)?v:'home';$$('.mobile-bottom-link').forEach(b=>b.classList.toggle('active',b.dataset.view===route));$$('.primary-nav-item').forEach(b=>b.classList.toggle('active',b.dataset.view===route));$$('.desktop-top-nav [data-view]').forEach(b=>b.classList.toggle('active',b.dataset.view===route))};
